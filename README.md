...
<!-- TODO: Add GIF/screenshot of a real query in Claude or VSCode -->
...
```
  INGEST (once)              BUILD & DEPLOY (on push)       SERVE (per request)

  Python Scraper             Python MCP Server              User
       ↓                          ↓                          ↓
  Five Leagues Data          FastMCP Tools              MCP Client (Claude/VSCode)
       ↓                          ↓                          ↓
  Pandas Clean               Docker Image                  LLM
       ↓                          ↓                          ↓
  Azure SQL                  Azure Container Registry   MCP Server (MCP Eleven)
                                   ↓                          ↓
                             Azure App Service           Football Database
```
